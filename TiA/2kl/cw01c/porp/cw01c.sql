...
--
-- Host: 127.0.0.1
-- Czas generowania: 08 Gru 2021, 13:03
...
INSERT INTO `nauczyciel` (`NauczycielID`, `NazwiskoImie`, `Wyksztalcenie`, `StazPracy`, `Telefon`, `Mail`) VALUES
...
ALTER TABLE `oceny`
  ...
  ADD CONSTRAINT `oceny_ibfk_2` FOREIGN KEY (`NauczycielID`) REFERENCES `nauczyciel` (`NauczycielID`),
