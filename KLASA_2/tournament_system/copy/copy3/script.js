const playerQ = 16; //ilość graczy

// total = Players-1
let total_roundsQ= playerQ-1; //eg.: [there is 8 players] in q-finals - 4rounds + s-fin -2 etc. 

let roundsQ = Math.log2(total_roundsQ);// np Q-finals, S-finals, finals, without-winner
